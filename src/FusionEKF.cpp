...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
    ...
    if (!is_initialized) {
        ...
        if (measurement_pack.sensor_type == MeasurementPackage::RADAR) {
             ...
             */
            float x = measurement_pack.raw_measurements[0] * cos(measurement_pack.raw_measurements[1]);
            float y = measurement_pack.raw_measurements[0] * sin(measurement_pack.raw_measurements[1]);
            ekf.x << x, y, 0, 0;
        }
    ...
    if (measurement_pack.sensor_type == MeasurementPackage::RADAR) {
        ...
        z << measurement_pack.raw_measurements[0], measurement_pack.raw_measurements[1], measurement_pack.raw_measurements[2];
        ...
        z << measurement_pack.raw_measurements[0], measurement_pack.raw_measurements[1];
        ekf.Update(z);
    }
